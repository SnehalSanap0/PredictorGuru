...
college_options = ['All'] + sorted(df['INSTITUTE NAME'].unique().tolist())  # New: Add college options
...
def search():
    ...
    college_name = request.form.get('college_name', 'All')  # New: Get college name from form
